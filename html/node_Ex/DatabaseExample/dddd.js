...
// 사용자를 인증하는 함수
var addUser = function(id, name,URL,img, callback) {
	console.log('호출됨');
	...
	pool.getConnection(function(err, conn) {
		...
		// SQL 문을 실행합니다.
		var exec = conn.query("insert into recipe values", [id, name,URL,img], function(err, rows) {
			conn.release();  // 반드시 해제해야 함
	...
	if (pool) {
		addUser(1,'dd','sss','fdfdf', function(err, addedUser) {
